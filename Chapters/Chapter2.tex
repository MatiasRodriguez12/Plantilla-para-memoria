...
En el presente trabajo, la incorporación del protocolo CAN se encuentra directamente vinculada a su utilización en la red de domótica desarrollada por Enertik. Dado que los dispositivos del sistema ya emplean este protocolo para su comunicación, su adopción permitió garantizar la compatibilidad con la infraestructura existente, evitando la necesidad de rediseñar los módulos involucrados.
...
Se utilizó el framework Ionic \citep{web_ionic} como base para el desarrollo de la aplicación, debido a que permite construir interfaces móviles a partir de tecnologías web, manteniendo una única base de código.
