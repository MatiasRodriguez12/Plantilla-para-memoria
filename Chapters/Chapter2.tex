...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.9]{./Figures/w5100.jpg}
...
mensajes provenientes de la red CAN, que se encarga de procesar la
...
una biblioteca destinada a la gestión de solicitudes HTTP. En este
