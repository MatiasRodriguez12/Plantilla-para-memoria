...
CAN L (normalmente un conductor adquiere una tensión igual a la fuente y el otro a 0 V), mientras que un bit recesivo (1 lógico) se corresponde con un estado en el que ambos conductores presentan niveles de tensión
similares.
...
Esta solución permite desacoplar la gestión del protocolo de comunicación
del procesamiento principal del sistema, simplificando el desarrollo del
firmware y facilitando la integración del dispositivo dentro de la red
