...
La interfaz final quedó organizada en cuatro pestañas principales:
home, luces, motores y energía. Cada una de ellas fue diseñada para
...
La figura \ref{fig:app_final} presenta las cuatro pantallas finales de
la aplicación desarrollada.

\begin{figure}[h]
	\centering
	\includegraphics[scale=0.11]{./Figures/app_pestañas.png}
	\caption{Diseño final de las principales pantallas de la aplicación móvil.}
	\label{fig:app_final}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.46]{./Figures/app_json_recibido_2.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.34]{./Figures/app_json_pulsador_2.png}
