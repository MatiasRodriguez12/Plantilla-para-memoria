...
pantalla principal. En esta vista se priorizó la visualización de las
variables más relevantes del sistema, organizadas en bloques claramente
diferenciados. La distribución permite acceder de forma inmediata a la
información crítica y a los controles de uso frecuente.
...
control de iluminación. En este diseño se priorizó una interfaz simple,
con controles de acceso directo y una disposición que facilita la
identificación rápida de cada componente.
...
\end{figure}
\newpage
La figura \ref{fig:pest_motores} muestra la pantalla de control de
motores. En este caso se adoptó una estructura centrada en la selección
del elemento móvil y en la visualización de sus controles asociados, con
el objetivo de simplificar la interacción del usuario.
...
control energético. Su diseño organiza los distintos subsistemas en
sectores independientes, lo que facilita la supervisión simultánea de
múltiples equipos.
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.23]{./Figures/prc10.png}
