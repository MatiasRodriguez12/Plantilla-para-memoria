...
Asimismo, se desarrolló una aplicación que permite al usuario disponer de una opción adicional (además de la pantalla principal) para el control integral de los equipos del vehículo, tanto de la red Enertik como de la red Victron.
...
\end{figure}
\newpage
En cuanto a la aplicación móvil, esta se ejecuta en dispositivos portátiles y es capaz de comunicarse con el módulo PRC10 para obtener y mostrar en pantalla las lecturas de las distintas variables del vehículo, así como enviar comandos de control hacia los dispositivos conectados a la red.
