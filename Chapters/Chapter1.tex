...
Finalmente, la Figura \ref{fig:esquema_equipo} presenta un esquema general de la solución propuesta, donde se ilustra la interacción entre los distintos componentes del sistema.
