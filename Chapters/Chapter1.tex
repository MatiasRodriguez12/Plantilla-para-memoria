...
\begin{itemize}
    ...
    \item Implementar los mecanismos necesarios para el intercambio de información entre ambos sistemas, permitiendo la supervisión y el control de variables energéticas.
