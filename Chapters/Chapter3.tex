...
Como se mencionó en la sección \ref{sec:1_4}, el ESP32 debe actuar como intermediario y vínculo entre las tres partes principales: módulo PRC10, Cerbo GX y aplicación móvil.
...
Ante esta situación, se analizaron alternativas disponibles dentro de los equipos comercializados por Enertik. En este contexto, se identificó el módulo transceiver mostrado en la figura \ref{fig:placa_transceiver}, utilizado en conjunto con la pantalla HMI de control.

Esta placa tiene como función realizar la conversión del
...
Al igual que en la pantalla principal, cada uno de estos controles
realiza una solicitud POST al endpoint pulsadores,
indicando el origen del comando y el nuevo valor, ya sea el estado del
pulsador o el valor del \textit{dimmer}.
...
Como resultado de la compilación, se obtiene un archivo en formato APK, 
que constituye el formato estándar de
distribución de aplicaciones para el sistema operativo Android. Este
archivo contiene todos los recursos necesarios para la instalación de
la aplicación, incluyendo el código ejecutable, bibliotecas y archivos de
configuración.
