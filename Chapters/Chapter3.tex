...
Cada vez que se accede a esta pestaña, se inicia un timer o
...
Al igual que en la pantalla principal, cada uno de estos controles realiza una solicitud POST al endpoint pulsadores, en la que se indica el origen del comando y el nuevo valor, ya sea el estado del pulsador o el valor del dimmer.
